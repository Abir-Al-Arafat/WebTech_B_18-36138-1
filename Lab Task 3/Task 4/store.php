<?php  
 ...
 {  
     ...
     $pass = $Cpass = ""; 
     if(isset($_POST['pass'])&&isset($_POST['Cpass'])) // checking if password is set or not
     {
        $pass = $_POST['pass'];
        $Cpass = $_POST['Cpass'];
 ...
 <html>  
      <head>  
           <title>Task 4 : Append Data to JSON File using PHP</title>  
      ...
      <body>  
           ...
           <div class="container" style="width:500px;">  
                <h3 align="">Task 4 : Append Data to JSON File</h3><br />                 
                <form method="post">  
                     <?php   
                     if(isset($error))  
                     {  
